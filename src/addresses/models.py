...
class Address(models.Model):
    ...
    name            = models.CharField(max_length=120, null=True, blank=True, help_text='¿Embarcar hacia? ¿Para quién?')
    nickname        = models.CharField(max_length=120, null=True, blank=True, help_text='Apodo de referencia interna')
